...
namespace SharpVk.HelloTriangle.Uwp
{
    /// <summary>
    ...
    public sealed partial class MainPage : Page
    {
        ...
        {
            this.surfaceWidth = (int)this.ActualWidth;
            this.surfaceHeight = (int)this.ActualHeight;
        ...
        private void CreateInstance()
        {
            this.instance = Instance.Create(new InstanceCreateInfo
            {
                ApplicationInfo = new ApplicationInfo
                {
                    ...
                    ApplicationVersion = Constants.ApiVersion10,
                    EngineName = "SharpVk",
        ...
        public Extent2D ChooseSwapExtent(SurfaceCapabilities capabilities)
        {
            ...
            else
            {
                return new Extent2D
                {
                    Width = Math.Max(capabilities.MinImageExtent.Width, (uint)Math.Min(capabilities.MaxImageExtent.Width, this.surfaceWidth)),
                    Height = Math.Max(capabilities.MinImageExtent.Height, (uint)Math.Min(capabilities.MaxImageExtent.Height, this.surfaceHeight))
                };
            }
        }
